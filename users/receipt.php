...
// Ensure payment_time is safe
$receipt['formatted_time'] = isset($receipt['payment_time']) 
    ? date("Y-m-d H:i:s", strtotime($receipt['payment_time']))
    : 'N/A';
...
ob_start();
include 'parking_receipt_template.php'; // this file must use $receipt and expect ['formatted_time']
$html = ob_get_clean();
